otData = [
    ...
    (
        "IFT Format1",
        [
            ("uint8", "Format", None, None, "Format identifier"),
            ("uint24", "Reserved", None, None, "Not used, set to 0"),
            ("uint8", "Flags", None, None, "Flags to signal presence of optional fields"),
            ("uint32", "CompatibilityId", 4, None, "Unique ID used to identify patches"),
            (
                "uint16",
                "MaxEntryIndex",
                None,
                None,
                "The largest entry index encoded in this table",
            ),
            (
                "uint16",
                ...
                None,
                None,
                "The largest Glyph Map entry index encoded in this table",
            ),
            (
                "uint24",
                "GlyphNum",
            ...
            ("LOffsetTo(IFTGlyphMap)", "GlyphMap", None, None, "Offset to a Glyph Map sub table"),
            ("LOffsetTo(IFTFeatureMap)", "FeatureMap", None, None, "Offset to a Feature Map sub table"),
            (
                "IFTBitMap('MaxEntryIndex')",
                "AppliedEntriesBitMap",
                None,
                None,
                "A bit map which tracks which entries have been applied",
            ),
            ("uint16", "URLTemplateLength", None, None, "Length of the urlTemplate"),
            ("Data('URLTemplateLength')", "URLTemplate", None, None, "A byte array containing a URL Template"),
            ("uint8", "PatchFormat", None, None, "Specifies the format of the patches"),
            (
                "uint32",
                "CFFCharStringsOffset",
                None,
                "Flags & 0x01",
                "Offset from the start of the CFF table to the CharStrings INDEX",
            ),
            (
                "uint32",
                ...
                None,
                "Flags & 0x02",
                "Offset from the start of the CFF2 table to the CharStrings INDEX",
            ),
        ]),
    (
        "IFT Format2",
        [
            ...
            ("uint24", "Reserved", None, None, "Not used, set to 0"),
            ("uint8", "Flags", None, None, "Flags to signal presence of optional fields"),
            ("uint32", "CompatibilityId", 4, 0, "Unique ID used to identify patches"),
            ("uint8", "DefaultPatchFormat", None, None, "Default patch format"),
            ("uint24", "EntryNum", None, None, "Number of entries"),
            ("LOffsetTo(IFTMappingEntries)", "Entries", None, None, "Offset to MappingEntries sub table"),
            (
                "LOffsetTo(IFTIdStringData)",
                "EntryIdStringData",
                None,
                None,
                "Offset to IdStringData sub table",
            ),
            ("uint16", "URLTemplateLength", None, None, "Length of the urlTemplate"),
            ("Data('URLTemplateLength')", "URLTemplate", None, None, "A byte array containing a URL Template"),
            (
    ...
    (
        "IFTGlyphMap",
        [
            ("uint16", "FirstMappedGlyph", None, None, "First glyph index mapped"),
            (
                "IFTGlyphMapEntryIndices",
                "EntryIndex",
                None,
                None,
                "The entry index for each glyph",
            ),
        ],
    ),
    (
        "IFTFeatureMap",
        [
            ("uint16", "FeatureCount", None, None, "Number of featureRecords"),
            (
                "IFTFeatureRecord",
                "FeatureRecords",
                "FeatureCount",
                0,
                "Provides mappings for a specific feature tag",
            ),
            (
                "IFTEntryMapRecords",
                "EntryMapRecords",
                None,
                None,
                "Provides the key (entry index) for each feature mapping",
            ),
        ],
    ),
    (
        "IFTFeatureRecord",
        [
            ("Tag", "FeatureTag", None, None, "The feature tag this mapping is for"),
            (
                "IFTEntryIndex",
                "FirstNewEntryIndex",
                None,
                None,
                "The first entry index this record maps to",
            ),
            (
                "IFTEntryIndex",
                "EntryMapNum",
                None,
                None,
                "The number of EntryMapRecords associated with this feature",
            ),
        ],
    ),
    (
        ...
        [
            (
                ...
                None,
                None,
                "First entry index in the subset",
            ),
            (
                "IFTEntryIndex",
                "LastEntryIndex",
                None,
                None,
                "Last entry index in the subset",
            ),
        ],
    ),
]
